...
import { getBanners, getPartners, getSiteConfig, pbImageUrl } from '@/lib/api/pocketbase'
...
export default async function HomePage() {
  ...
  // ✅ FIX 4: تصویر سکشن "درباره ما" و "نرم‌افزار" از PocketBase
  // در PocketBase توی site_config فیلد about_image و software_image بذار
  const aboutImageUrl = siteConfig?.about_image
    ? pbImageUrl(siteConfig, siteConfig.about_image)
    : null

  const softwareImageUrl = siteConfig?.software_image
    ? pbImageUrl(siteConfig, siteConfig.software_image)
    : null

  // تصاویر محصولات از products_ui — prefetch برای ۶ محصول اول
  // (در home فقط از imageUrl اگه در product باشه استفاده میکنیم، وگرنه placeholder)
  ...
  return (
    <div dir="rtl">
      ...
      <section className="py-20 bg-bg-primary">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
            ...
            {/* ✅ FIX 4: تصویر از PocketBase — اگه about_image پر باشه نشون میده */}
            <div className="relative flex items-center justify-center">
              {aboutImageUrl ? (
                <div className="relative w-full max-w-sm h-72 md:h-80 rounded-3xl overflow-hidden border border-border-default shadow-lg">
                  <Image
                    src={aboutImageUrl}
                ...
                // Fallback: همون placeholder قبلی
              ...
              {/* Floating cards — همیشه نشون داده میشن */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.slice(0, 6).map((product: any) => (
                <ProductCard
                  key={product.id}
                  product={product}
                  // در home تصویر رو نداریم prefetch نکردیم — ProductCard خودش placeholder نشون میده
                  // برای تصویر در home باید prefetchImages رو اینجا هم صدا بزنیم (اختیاری)
                />
              ))}
            </div>
          ) : (
      ...
      <section className="py-20 bg-bg-primary">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
            {/* ✅ FIX 4: تصویر نرم‌افزار از PocketBase */}
            <div className="flex items-center justify-center order-1">
              {softwareImageUrl ? (
                <div className="relative w-full max-w-sm h-64 md:h-72 rounded-2xl overflow-hidden border border-border-default shadow-lg">
                  <Image
                ...
                // Fallback: همون mock browser قبلی
            ...
            <div className="order-2">
              <SectionTitle
                ...
                subtitle={siteConfig?.software_description ?? 'پلتفرم جامع مدیریت ناوگان با قابلیت ردیابی لحظه‌ای، گزارش‌گیری دقیق و هشدارهای هوشمند'}
              />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <SectionTitle
              ...
              subtitle="ردیابی ناوگان در کف دست شما — همیشه و همه‌جا"
              centered
            />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-xl mx-auto text-center">
            ...
            <p className="text-white/80 mb-8">
              از آخرین محصولات، تخفیف‌ها و اخبار GPS باخبر شوید
            </p>
            <NewsletterForm />
          </div>
        </div>
